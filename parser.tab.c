...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "conmand",
  "statement", "expression", "term", "factor", YY_NULLPTR
};
...
{
      -6,     1,    -6,    -6,    -6,     0,     0,    -2,    10,    12,
      -6,    -6,     8,    -6,     0,     0,     0,     0,    -6,    12,
      12,    -6,    -6
};
...
{
       4,     0,     1,    14,     3,     0,     0,     0,     5,     8,
      11,    13,     0,     2,     0,     0,     0,     0,    12,     6,
       7,     9,    10
};
...
{
      11,     2,    13,     3,     3,     4,     5,     5,    12,     6,
       6,    21,    22,    14,    15,    14,    15,     0,    18,    16,
      17,    19,    20
};
